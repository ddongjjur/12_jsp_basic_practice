...
<body>
	...
	<form action="fileEx02_upload_prac.jsp" method="post" enctype="multipart/form-data">
		<fieldset>
			...
			<p><input type="button" value="파일 리스트" onclick="location.href='fileEx02_list_prac.jsp'"></p>
		</fieldset>
	</form>
